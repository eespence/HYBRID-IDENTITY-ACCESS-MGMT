...
## Installation and Configuration Evidence

### Entra Connect Download Portal

![Download Portal](../screenshots/module-03/SYNC01-EntraConnect-Download-Portal.png)

### Entra Connect Download Page

![Download Page](../screenshots/module-03/SYNC01-EntraConnect-DownloadPage.png)

### Required Components

![Required Components](../screenshots/module-03/SYNC01-EntraConnect-03-RequiredComponents.png)

### Group Filtering Configuration

![Group Filtering](../screenshots/module-03/SYNC01-EntraConnect-GroupFiltering-AADSyncUsers.png)

### MFA Admin Approval

![MFA Admin Approval](../screenshots/module-03/SYNC01-EntraConnect-MFA-Admin-Approval.png)

### Optional Features — Password Hash Synchronization

![Optional Features PHS](../screenshots/module-03/SYNC01-EntraConnect-OptionalFeatures-PHS.png)

### Kerberos Ticket Purge and Reboot

![Kerberos Ticket Purge and Reboot](../screenshots/module-03/SYNC01-Kerberos-Ticket-Purge-And-Reboot.png)
...
| Namespace Alignment   | ✅ Corrected   |
| Scoped Sync           | ✅ Validated   |
| Hybrid Authentication | ✅ Confirmed   |
